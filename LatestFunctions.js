...
// Fully revised – fixes Bronze→White transfer issue
// ===========================================
(function () {
"use strict";
...
// =================================================
// Detect variety from input text
// =================================================
...
const bSel=document.getElementById(prefix==="sire"?"sireAlleleb":"damAlleleb");
const cSel=document.getElementById(prefix==="sire"?"sireAlleleC":"damAlleleC");

if(bSel && bSel.value!=="bb") bSel.value="bb";

if(type==="white"){
if(cSel && cSel.value!=="cc") cSel.value="cc";
}
...
patchArray(window.maleOffspring);
patchArray(window.femaleOffspring);

}

// =================================================
// Wrap sire/dam variety functions
// =================================================
function wrapVarietyFn(fnName,prefix){
...
setTimeout(()=>forceApply(prefix),200);
}
...
// fallback to name if genotype didn't decide
if(!type && varietyInput){
...
setTimeout(()=>forceApply(parent),60);
setTimeout(()=>forceApply(parent),160);
...
if(typeof window.calculateOffspringWrapper!=="function") return;
if(window._bbCalcPatched) return;
