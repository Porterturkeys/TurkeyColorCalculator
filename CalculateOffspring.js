                        ...
                        for (const outcomePn of combinationsPn.combinations) {
                            for (const outcomeR of combinationsR.combinations) {
                                for (const outcomeSl of combinationsSl.combinations) {
                                    ...
                                    let phenotype7B = phenotypeMapping7B[shortGenotype];
                                    let phenotype7C = phenotypeMapping7C[shortGenotype];                                      
                                    ...
                                    let phenotype = phenotype1 || phenotype1A || phenotype1B || phenotype1C || phenotype1D || phenotype1E || phenotype2 || phenotype2A ||  phenotype3 || phenotype3A || phenotype4 || phenotype5 || phenotype6 || phenotype7 || phenotype7A || phenotype7B || phenotype7C || phenotype8 || phenotype9 || phenotype10 || phenotype11 || phenotype12 || phenotype13 || phenotype14 || phenotype15;
